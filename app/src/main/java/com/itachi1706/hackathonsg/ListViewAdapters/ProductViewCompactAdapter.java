 ...
 */
public class ProductViewCompactAdapter extends ArrayAdapter<JSONProducts>
{

    private ArrayList<JSONProducts> items;
    private Context context;

    public ProductViewCompactAdapter(Context context, int textViewResourceid, ArrayList<JSONProducts> objects)
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        if (v == null)
        {
            ...
            v = inflater.inflate(R.layout.listview_products_compact, parent, false);
        }
