 ...
 */
public class SimilarProductViewAdapter extends ArrayAdapter<JSONProducts>
{

    private ArrayList<JSONProducts> items;
    private Context context;

    public SimilarProductViewAdapter(Context context, int textViewResourceid, ArrayList<JSONProducts> objects)
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        if (i != null)
        {
            ...
            if (productAvailbility != null)
            {
                ...
                {
                    //Available
                    productAvailbility.setText("Available (" + i.getStore() + ")");
                    productAvailbility.setTextColor(Color.GREEN);
                }
                else
                {
                    //Not Available
                    productAvailbility.setText("Out Of Stock (" + i.getStore() + ")");
